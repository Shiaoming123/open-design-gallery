...
- Package: `elastic-ui`
- Intent: Analytic product interface language. Light-gray application shells, white panels, Elastic blue action, semantic data color, and dense but humane dashboard composition.
