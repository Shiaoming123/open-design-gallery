...
- Package: `aws-cloudscape`
- Intent: Cloud operations interface language. Dense, accessible, white-and-gray surfaces with blue action focus, status clarity, and 4px-grid discipline.
