...
- Package: `nhs-design-system`
- Intent: Public health service UI. NHS Blue recognition, off-white reading canvas, direct task flows, and uncompromising accessible focus states.
