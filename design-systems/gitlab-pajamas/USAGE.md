...
- Package: `gitlab-pajamas`
- Intent: GitLab product UI language. Token-led, contribution-oriented, neutral product surfaces with purple action emphasis, orange brand warmth, and dense software workflow patterns.
