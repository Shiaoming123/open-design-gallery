...
- Package: `workday-canvas`
- Intent: Workday enterprise design language. Airy task surfaces, Roboto typography, blue primary actions, semantic workflow states, rounded-but-controlled shape, and purposeful depth.
