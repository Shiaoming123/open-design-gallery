...
- Package: `clarity-design-system`
- Intent: Enterprise application system. Cool construction neutrals, blue operational emphasis, compact typography, explicit states, and web-component-like structure.
