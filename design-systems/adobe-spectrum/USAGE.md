...
- Package: `adobe-spectrum`
- Intent: Product design system. Neutral gray canvases, precise blue action, compact components, and token-led consistency.
